                        ...
                        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                                    ...
                                    <div class="bg-white rounded-lg shadow-sm p-6">
                                        ...
                                        <?php if($produksi && $produksi->status_pra_produksi === 'disetujui'): ?>
                                            <form id="combinedProduksiForm" method="POST" action="<?php echo e(route('mahasiswa.produksi.store.produksi')); ?>" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                            ...
                            <div id="content-pasca-produksi" class="tab-content hidden">
                                <div class="bg-white rounded-lg shadow-sm p-6 py-4">
                                    ...
                                    <?php if($produksi && $produksi->status_produksi === 'disetujui'): ?>
                                    <form method="POST" action="<?php echo e(route('mahasiswa.produksi.store.pasca')); ?>" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-yellow-400 transition cursor-pointer" onclick="document.getElementById('filePasca').click()">
                                         ...
                                         <?php if($produksi?->file_pasca_produksi): ?>
                                            <div class="mt-3 text-center">
                                                <a href="<?php echo e(route('mahasiswa.produksi.download', [$produksi->id, 'pasca'])); ?>" class="text-sm text-yellow-600 hover:underline">
...
<?php echo $__env->make('mahasiswa.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\C\Tamago-ISI\resources\views/mahasiswa/produksi/manage.blade.php ENDPATH**/ ?>