                ...
                <form id="proposalForm" method="POST" action="<?php echo e(route('mahasiswa.proposal.submit')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <select id="rumpun_ilmu" name="rumpun_ilmu"
                            ...
                            <option value="Penciptaan Seni" <?php echo e(old('rumpun_ilmu') == 'Penciptaan Seni' ? 'selected' : ''); ?>>Penciptaan Seni</option>
                            <option value="Pengkajian Seni" <?php echo e(old('rumpun_ilmu') == 'Pengkajian Seni' ? 'selected' : ''); ?>>Pengkajian Seni</option>
                            <option value="Media Rekam" <?php echo e(old('rumpun_ilmu') == 'Media Rekam' ? 'selected' : ''); ?>>Media Rekam</option>
                        </select>
                    </div>
                    <!-- Dosen Pembimbing -->
                    <div class="mb-6">
...
<?php echo $__env->make('mahasiswa.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Tamago-ISI\resources\views/mahasiswa/proposal.blade.php ENDPATH**/ ?>