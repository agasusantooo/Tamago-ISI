...
<aside class="w-64 bg-white shadow-md flex flex-col" id="sidebar">
    ...
    <nav class="flex-1 overflow-y-auto py-4">
        <ul class="space-y-1 px-3">
            ...
            <li>
                <a href="#" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition text-gray-700 hover:bg-blue-50">
            ...
            <li>
                <a href="<?php echo e(route('profile.edit')); ?>"
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition
                   <?php echo e(request()->routeIs('profile.edit') ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-700 hover:bg-blue-50'); ?>">
...
<?php /**PATH D:\Tamago-ISI\resources\views/dospem/partials/sidebar-dospem.blade.php ENDPATH**/ ?>