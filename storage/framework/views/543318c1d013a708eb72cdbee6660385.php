            ...
            <form method="POST" action="<?php echo e(route('mahasiswa.tefa-fair.store')); ?>" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <?php if(isset($tefaFair) && $tefaFair->file_presentasi): ?>
                        <p class="text-xs text-gray-600 mt-2">File saat ini: <a href="<?php echo e(Storage::url($tefaFair->file_presentasi)); ?>" target="_blank" class="text-yellow-600 hover:underline"><?php echo e(basename($tefaFair->file_presentasi)); ?></a></p>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('mahasiswa.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\C\Tamago-ISI\resources\views/mahasiswa/tefa-fair/create.blade.php ENDPATH**/ ?>