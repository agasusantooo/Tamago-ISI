        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventDrop: function(info) {
                    ...
                    let url = "<?php echo e(route('koordinator_ta.jadwal.update', ['id' => ':id'])); ?>";
                ...
                eventClick: function(info) {
                    if (confirm("Apakah Anda yakin ingin menghapus acara '" + info.event.title + "'?")) {
                        let url = "<?php echo e(route('koordinator_ta.jadwal.destroy', ['id' => ':id'])); ?>";
...
<?php /**PATH D:\Tamago-ISI\resources\views/koordinator_ta/jadwal.blade.php ENDPATH**/ ?>