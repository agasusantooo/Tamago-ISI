                                    ...
                                    <form method="POST" action="<?php echo e(route('mahasiswa.produksi.store.pasca')); ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-green-400 transition cursor-pointer" onclick="document.getElementById('filePasca').click()">
                                         ...
                                         <?php if($produksi?->file_pasca_produksi): ?>
                                            <div class="mt-3 text-center">
                                                <a href="<?php echo e(route('mahasiswa.produksi.download', [$produksi->id, 'pasca'])); ?>" class="text-sm text-blue-600 hover:underline">
...
<?php echo $__env->make('mahasiswa.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Tamago-ISI\resources\views/mahasiswa/produksi/manage.blade.php ENDPATH**/ ?>