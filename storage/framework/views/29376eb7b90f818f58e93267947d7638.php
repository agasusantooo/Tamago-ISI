            ...
            (function () {
                try {
                    ...
                    window.toggleTheme = function () {
                        ...
                        try {
                            var themeUrl = <?php echo json_encode(route('profile.theme'), 15, 512) ?>;
                            fetch(themeUrl, {
                                method: 'POST',
                                headers: {
...
$__html = app('livewire')->mount($__name, $__params, 'lw-726803575-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH D:\C\Tamago-ISI\resources\views\components\layouts\app.blade.php ENDPATH**/ ?>