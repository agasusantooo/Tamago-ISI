                ...
                <div class="max-w-7xl mx-auto">
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="text-sm text-gray-600">Mahasiswa Aktif: <span class="font-semibold text-blue-700"><?php echo e($jumlahMahasiswaAktif ?? '-'); ?></span> | Tugas Review: <span class="font-semibold text-blue-700"><?php echo e($jumlahTugasReview ?? '-'); ?></span></div>
                        </div>
                                    ...
                                    <?php if(isset($mahasiswaBimbingan) && count($mahasiswaBimbingan)): ?>
                                        <?php $__empty_1 = true; $__currentLoopData = $mahasiswaBimbingan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mhs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr class="hover:bg-blue-50 transition">
                                                ...
                                                <td class="px-4 py-3 text-center">
                                                    <a href="<?php echo e(route('dospem.mahasiswa-bimbingan.detail', ['id' => $mhs->id])); ?>" class="px-3 py-1 text-xs bg-blue-600 text-white rounded hover:bg-blue-700">
...
<?php /**PATH C:\laragon\www\tam\ooo\Tamago-ISI-main\resources\views/dospem/mahasiswa-bimbingan.blade.php ENDPATH**/ ?>