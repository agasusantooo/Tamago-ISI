                            ...
                            <div class="bg-white rounded-xl shadow-sm p-6">
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center justify-between p-4 bg-yellow-50 border-l-4 border-yellow-500 rounded-lg">
                                        ...
                                        <a href="<?php echo e(route('mahasiswa.proposal')); ?>" class="inline-block px-4 py-2 text-sm font-medium text-white bg-yellow-500 rounded-lg hover:bg-yellow-600">
                                            Kerjakan
                                        </a>
                                    </div>
...
<?php /**PATH D:\C\Tamago-ISI\resources\views/mahasiswa/dashboard.blade.php ENDPATH**/ ?>