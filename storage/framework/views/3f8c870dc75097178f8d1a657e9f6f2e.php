            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <?php if(!empty($missingProposal)): ?>
                    <div class="mb-4 p-4 bg-red-50 border-l-4 border-red-400 rounded">
                        ...
                        <div class="mt-3">
                            <a href="<?php echo e(route('mahasiswa.proposal')); ?>" class="inline-block px-4 py-2 bg-red-600 text-white rounded">Lihat Proposal</a>
                        </div>
                    </div>
                <?php endif; ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1977617574-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('mahasiswa.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tam\ooo\Tamago-ISI-main\resources\views/mahasiswa/ujian-ta.blade.php ENDPATH**/ ?>