        ...
        <ul class="space-y-1 px-3">
            <li>
                <a href="<?php echo e(route('admin.dashboard')); ?>"
                   ...
                   <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-red-100 text-red-700 font-semibold' : 'text-gray-700 hover:bg-red-50'); ?>">
            ...
            <li>
                <a href="<?php echo e(route('admin.users')); ?>"
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg font-medium transition 
                   <?php echo e(request()->routeIs('admin.users') ? 'bg-red-100 text-red-700 font-semibold' : 'text-gray-700 hover:bg-red-50'); ?>">
...
<?php /**PATH D:\C\Tamago-ISI\resources\views\admin\partials\sidebar-admin.blade.php ENDPATH**/ ?>