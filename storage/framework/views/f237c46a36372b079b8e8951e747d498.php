                            ...
                            <?php if($storyConference): ?>
                                <div class="bg-white rounded-lg shadow-sm p-6">
                                    ...
                                    <div class="space-y-3 text-sm">
                                        ...
                                        <?php if($storyConference->file_presentasi): ?>
                                            <div>
                                                <a href="<?php echo e(route('mahasiswa.story-conference.download', $storyConference->id)); ?>" 
                                    ...
                                    <?php if($storyConference->status == 'menunggu_persetujuan'): ?>
                                        <div class="mt-6">
                                            <form method="POST" action="<?php echo e(route('mahasiswa.story-conference.cancel', $storyConference->id)); ?>" onsubmit="return confirm('Apakah Anda yakin ingin membatalkan pendaftaran?')">
                                                <?php echo csrf_field(); ?>
...
<?php $__env->startSection('title', 'Story Conference'); ?>
...
[$__name, $__params] = $__split('mahasiswa.story-conference');

$__html = app('livewire')->mount($__name, $__params, 'lw-2372140778-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('mahasiswa.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tam\ooo\Tamago-ISI-main\resources\views/mahasiswa/story-conference.blade.php ENDPATH**/ ?>