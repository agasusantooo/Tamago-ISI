                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="mt-6 bg-white rounded-xl shadow-sm p-6 max-w-md">
                        <div class="flex items-center justify-between">
                            ...
                            <?php if(!empty($sampleStudentName)): ?>
                                <div class="text-right">
                                    <div class="text-sm text-gray-500">Mahasiswa</div>
                                    <div class="text-base font-medium text-gray-800"><?php echo e($sampleStudentName); ?></div>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mt-6 flex items-center">
                            ...
                            <div class="flex items-center justify-center w-40 h-40">
                                <svg width="110" height="110" viewBox="0 0 110 110">
                                    ...
                                    <g transform="translate(55,55)">
                                        <circle r="<?php echo e($radius); ?>" fill="none" stroke="#EEF2F7" stroke-width="12" />
                                        <circle r="<?php echo e($radius); ?>" fill="none" stroke="url(#g1)" stroke-width="12"
                                            stroke-linecap="round"
                                            stroke-dasharray="<?php echo e($dash); ?> <?php echo e(max(0, $circumference - $dash)); ?>"
                                            transform="rotate(-90)"
                                        />
                                        <text x="0" y="6" text-anchor="middle" font-size="20" font-weight="700" fill="#92400E"><?php echo e($pct); ?>%</text>
                                    </g>
                                </svg>
                            </div>
                            ...
                            <div class="ml-6 flex-1">
                                ...
                                <?php if(!empty($sampleProgress['details'])): ?>
                                    <div class="text-sm text-gray-600">
                                        <?php $__currentLoopData = $sampleProgress['details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex justify-between py-1">
                                                <div><?php echo e($d['name']); ?></div>
                                                <div class="font-medium"><?php echo e(intval($d['fraction'] * 100)); ?>%</div>
                                            </div>
                                ...
                                <div class="mt-4 text-xs text-gray-400">Raw: <pre class="whitespace-pre-wrap"><?php echo e(isset($sampleProgress) ? json_encode($sampleProgress) : 'null'); ?></pre></div>
                            </div>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH D:\C\Tamago-ISI\resources\views/koordinator_ta/dashboard.blade.php ENDPATH**/ ?>