...
<script>
    async function fetchProposalUpdates() {
        try {
            const res = await fetch("<?php echo e(route('mahasiswa.proposal.check-updates')); ?>", { headers: { 'Accept': 'application/json' } });
            if (!res.ok) return;
...
<?php echo $__env->make('mahasiswa.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\C\Tamago-ISI\resources\views/mahasiswa/proposal/index.blade.php ENDPATH**/ ?>