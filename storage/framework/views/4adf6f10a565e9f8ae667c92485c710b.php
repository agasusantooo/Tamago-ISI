<header class="bg-white">
    <div class="flex items-center px-6 py-4">
        <div class="flex-1 mr-8 flex items-center space-x-3">
            <img src="<?php echo e(asset('images/logo-isi.png')); ?>" alt="Logo ISI" class="w-10 h-10 object-contain rounded-lg">
            <div>
...
<?php /**PATH D:\C\Tamago-ISI\resources\views/kaprodi/partials/header-kaprodi.blade.php ENDPATH**/ ?>