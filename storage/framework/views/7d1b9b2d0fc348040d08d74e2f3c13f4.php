                ...
                <ul class="space-y-1 px-3">
                    <li>
                        <a href="<?php echo e(route('admin.dashboard')); ?>"
                            ...
                            <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-red-50 text-red-900' : 'text-gray-700 hover:bg-gray-100'); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.users')); ?>"
                            class="flex items-center space-x-3 px-4 py-3 rounded-lg transition font-medium
                            <?php echo e(request()->routeIs('admin.users') ? 'bg-red-50 text-red-900' : 'text-gray-700 hover:bg-gray-100'); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.roles')); ?>"
                            class="flex items-center space-x-3 px-4 py-3 rounded-lg transition font-medium
                            <?php echo e(request()->routeIs('admin.roles') ? 'bg-red-50 text-red-900' : 'text-gray-700 hover:bg-gray-100'); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.logs')); ?>"
                            class="flex items-center space-x-3 px-4 py-3 rounded-lg transition font-medium
                            <?php echo e(request()->routeIs('admin.logs') ? 'bg-red-50 text-red-900' : 'text-gray-700 hover:bg-gray-100'); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.settings')); ?>"
                            class="flex items-center space-x-3 px-4 py-3 rounded-lg transition font-medium
                            <?php echo e(request()->routeIs('admin.settings') ? 'bg-red-50 text-red-900' : 'text-gray-700 hover:bg-gray-100'); ?>">
                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                            <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-blue-500">
                                ...
                                <p class="text-3xl font-bold text-gray-800"><?php echo e($totalMahasiswa); ?></p>
                            </div>
                            ...
                            <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-green-500">
                                ...
                                <p class="text-3xl font-bold text-gray-800"><?php echo e($totalDosen); ?></p>
                            </div>
                            ...
                            <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-purple-500">
                                ...
                                <p class="text-3xl font-bold text-gray-800"><?php echo e($totalKorprodi); ?></p>
                            </div>
                            ...
                            <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-orange-500">
                                ...
                                <p class="text-3xl font-bold text-gray-800"><?php echo e($totalAdmin); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div class="bg-white rounded-xl shadow-sm p-6">
                            ...
                            <div class="space-y-3">
                                <?php $__empty_1 = true; $__currentLoopData = $aktivitasTerakhir; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aktivitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="p-3 bg-gray-50 rounded-lg">
                                        <p class="text-sm font-medium"><?php echo e($aktivitas->description); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($aktivitas->created_at); ?></p>
                                    </div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm p-6">
                            ...
                            <div class="space-y-3">
                                <?php $__empty_1 = true; $__currentLoopData = $notifikasiPenting ?? collect(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="p-3 bg-blue-50 border-l-4 border-blue-500 rounded-lg">
                                        <p class="text-sm font-semibold"><?php echo e($notif->title); ?></p>
                                        <p class="text-xs text-gray-600"><?php echo e($notif->message); ?></p>
                                        <p class="text-xs text-gray-500 mt-1"><?php echo e($notif->created_at); ?></p>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php /**PATH D:\C\Tamago-ISI\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>