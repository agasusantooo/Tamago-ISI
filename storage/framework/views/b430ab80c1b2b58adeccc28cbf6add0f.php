...
<body class="bg-gray-100">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="bg-white rounded-xl shadow-sm p-6">
                                    ...
                                    <div class="flex justify-center items-center">
                                        <div id="progressCard" class="relative w-40 h-40" data-percentage="<?php echo e($percentage); ?>" data-total-stages="<?php echo e($totalStages); ?>">
                                            ...
                                            <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-2">
                                                <span id="progressPercent" class="text-3xl font-bold text-yellow-600"><?php echo e($percentage); ?>%</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="bg-white rounded-xl shadow-sm p-6">
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <a href="<?php echo e(route('mahasiswa.bimbingan.index')); ?>" class="w-full mt-3 px-4 py-2 bg-yellow-500 text-white text-sm font-medium rounded-lg hover:bg-yellow-600 transition text-center block">
                            ...
                            <div class="bg-white rounded-xl shadow-sm p-6">
                                ...
                                <div class="space-y-4">
                                    <div class="bg-yellow-50 rounded-lg p-4 flex items-center justify-between border-l-4 border-yellow-500 shadow-sm">
                                        ...
                                        <a href="<?php echo e(route('mahasiswa.proposal.index')); ?>" class="px-4 py-2 text-sm font-medium text-white bg-yellow-500 rounded-md hover:bg-yellow-600 shadow">Kerjakan</a>
                                    </div>
                                    <div class="bg-yellow-50 rounded-lg p-4 flex items-center justify-between border-l-4 border-yellow-500 shadow-sm">
                                        <div>
                                        ...
                                        <a href="<?php echo e(route('mahasiswa.story-conference.index')); ?>" class="px-4 py-2 text-sm font-medium text-white bg-yellow-500 rounded-md hover:bg-yellow-600 shadow">Daftar</a>
                                    </div>
                                    <div class="bg-yellow-50 rounded-lg p-4 flex items-center justify-between border-l-4 border-yellow-500 shadow-sm">
                                        <div>
                                        ...
                                        <a href="#" class="px-4 py-2 text-sm font-medium text-white bg-yellow-500 rounded-md opacity-50 cursor-not-allowed shadow" tabindex="-1" aria-disabled="true">Lihat Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            Livewire.emit('updateProgress', <?php echo e($percentage); ?>);
        });
    </script>
</body>
</html>
<?php /**PATH D:\C\Tamago-ISI\resources\views\dashboards\mahasiswa.blade.php ENDPATH**/ ?>