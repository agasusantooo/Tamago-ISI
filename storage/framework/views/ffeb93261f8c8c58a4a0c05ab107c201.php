<?php $__env->startSection('title', 'Daftar Story Conference - Tamago ISI'); ?>
                            ...
                            <div class="flex items-start space-x-4">
                                <div class="flex-shrink-0">
                                    <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm">
                                        <i class="fas fa-presentation-screen text-2xl text-yellow-600"></i>
                                    </div>
                                </div>
                                <div class="flex-1">
                    ...
                    <div class="mt-6 pt-6 border-t">
                        ...
                        <div class="space-y-3">
                            ...
                            <?php if($storyConference->status == 'diterima' || $storyConference->status == 'konfirmasi_akhir'): ?>
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 bg-yellow-100 rounded-full flex items-center justify-center">
                                        <i class="fas fa-clipboard-check text-yellow-600 text-xs"></i>
                                    </div>
                                    <div>
                    ...
                    <form method="POST" action="<?php echo e(route('mahasiswa.story-conference.store')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="judul_karya" name="judul_karya" 
                                ...
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent text-sm"
                        ...
                        <!-- Submit Button -->
                        <button type="submit" 
                            class="w-full bg-yellow-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-yellow-700 transition">
...
<?php echo $__env->make('mahasiswa.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\C\Tamago-ISI\resources\views/mahasiswa/story-conference/create.blade.php ENDPATH**/ ?>