                                ...
                                <table class="w-full">
                                    ...
                                    <tbody class="divide-y divide-green-50">
                                        ...
                                        <tr class="hover:bg-green-50 transition">
                                            <td class="px-4 py-3 font-mono text-sm text-gray-600"><?php echo e($mk['kode']); ?></td>
                                            <td class="px-4 py-3 font-medium text-gray-900"><?php echo e($mk['nama']); ?></td>
                                            <td class="px-4 py-3 text-center text-sm text-gray-600"><?php echo e($mk['sks']); ?></td>
...
<?php /**PATH D:\C\Tamago-ISI\resources\views/koordinator_ta/matakuliah.blade.php ENDPATH**/ ?>