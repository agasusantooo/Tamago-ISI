...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 px-4 py-3 bg-yellow-50 border border-yellow-300 rounded-lg">
                            ...
                            <span class="font-medium text-yellow-700"><?php echo e(optional(Auth::user()->mahasiswa)->status ?? 'Aktif'); ?></span>
                        </div>
                    </div>
...
<?php echo $__env->make('mahasiswa.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\C\Tamago-ISI\resources\views/mahasiswa/akun.blade.php ENDPATH**/ ?>