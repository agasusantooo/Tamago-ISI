...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="tel" name="phone" value="<?php echo e(old('phone', optional(Auth::user())->phone)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="birthdate" value="<?php echo e(old('birthdate', optional(Auth::user())->birthdate)); ?>"
                                   class="profile-input w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 text-gray-600"
                                   disabled>
                        </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="address" rows="3" placeholder="Masukkan alamat lengkap"
                                      class="profile-input w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 text-gray-600"
                                      disabled><?php echo e(old('address', optional(Auth::user())->address)); ?></textarea>
                        </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nim" value="<?php echo e(old('nim', optional(Auth::user()->mahasiswa)->nim)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e(optional(Auth::user()->mahasiswa)->program_studi); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e(optional(Auth::user()->mahasiswa)->angkatan); ?>"
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 px-4 py-3 bg-green-50 border border-green-300 rounded-lg">
                            ...
                            <span class="font-medium text-green-700"><?php echo e(optional(Auth::user()->mahasiswa)->status ?? 'Aktif'); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea rows="3" placeholder="Judul tugas akhir"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 text-gray-600"
                                  disabled readonly><?php echo e(optional(Auth::user()->mahasiswa)->judul_tugas); ?></textarea>
                    </div>
                </div>
            </div>
        </form>
...
<?php echo $__env->make('mahasiswa.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tam\ooo\Tamago-ISI-main\resources\views/mahasiswa/akun.blade.php ENDPATH**/ ?>