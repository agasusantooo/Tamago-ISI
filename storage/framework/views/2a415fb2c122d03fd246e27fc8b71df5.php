            ...
            <div>
                ...
                <p class="text-sm mt-1">Status: 
                    <span class="font-semibold px-2 py-1 text-xs rounded-full 
                        <?php if(isset($displayStatus) && $displayStatus == 'lulus'): ?> bg-green-200 text-green-800
                        <?php elseif(isset($displayStatus) && $displayStatus == 'aktif'): ?> bg-yellow-200 text-yellow-800
                        <?php else: ?> bg-red-200 text-red-800
                        <?php endif; ?>
                    ">
                        <?php echo e(ucfirst($displayStatus ?? ($mahasiswa->status ?? ''))); ?>
        ...
        <div class="mt-6">
            ...
            <div class="flex items-center mt-2">
                <div class="w-full bg-gray-200 rounded-full h-4">
                    <div class="bg-teal-600 h-4 rounded-full" style="width: <?php echo e((int) $progressData['percentage']); ?>%"></div>
                </div>
...
<?php echo $__env->make('kaprodi.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\C\Tamago-ISI\resources\views/kaprodi/monitoring-detail.blade.php ENDPATH**/ ?>