        ...
        <aside class="w-64 bg-white shadow-lg flex flex-col" id="sidebar">
            ...
            <nav class="flex-1 overflow-y-auto py-4">
                <ul class="space-y-1 px-3">
                    <li>
                        <a href="<?php echo e(route('kaprodi.dashboard')); ?>" class="flex items-center space-x-3 px-4 py-3 <?php echo e(request()->routeIs('kaprodi.dashboard') ? 'text-purple-900 bg-purple-50' : 'text-gray-700 hover:bg-gray-100'); ?> rounded-lg font-medium transition">
...
</html><?php /**PATH D:\Tamago-ISI\resources\views/dashboards/kaprodi.blade.php ENDPATH**/ ?>