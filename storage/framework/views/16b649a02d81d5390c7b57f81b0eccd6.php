                ...
                <ul class="space-y-1 px-3">
                    <li>
                        <a href="<?php echo e(route('dashboard')); ?>"
                            ...
                            <?php echo e(request()->routeIs('dashboard') ? 'bg-red-50 text-red-900' : 'text-gray-700 hover:bg-gray-100'); ?>">
                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-xl shadow-sm p-6">
                            ...
                            <div class="space-y-3">
                                <?php $__empty_1 = true; $__currentLoopData = $notifikasiPenting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php /**PATH D:\C\Tamago-ISI\resources\views\dashboards\admin.blade.php ENDPATH**/ ?>