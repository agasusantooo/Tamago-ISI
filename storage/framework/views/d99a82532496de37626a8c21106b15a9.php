...
<body class="bg-purple-50 text-gray-800">
                            ...
                            <table class="w-full text-sm">
                                ...
                                <tbody id="ujianTableBody">
                                    ...
                                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                                        <td class="py-3 px-4 font-medium"><?php echo e($ujian['nim']); ?></td>
                                        <td class="py-3 px-4"><?php echo e($ujian['nama']); ?></td>
                                        <td class="py-3 px-4 text-sm"><?php echo e($ujian['judul']); ?></td>
                                        <td class="py-3 px-4 text-sm"><?php echo e($ujian['tanggal']); ?></td>
                                        <td class="py-3 px-4">
                                            <span class="px-3 py-1 rounded-full text-xs font-medium
                                                <?php if($ujian['status'] == 'Sudah Dinilai'): ?> bg-green-100 text-green-800
                                                <?php else: ?> bg-yellow-100 text-yellow-800 <?php endif; ?>">
                                                <?php echo e($ujian['status']); ?>

                                            </span>
                                        </td>
                                        <td class="py-3 px-4 text-center font-semibold">
                                            <?php echo e($ujian['nilai'] ?? '-'); ?>

                                        </td>
                                        <td class="py-3 px-4 text-center">
                                            <?php if($ujian['status'] == 'Belum Dinilai'): ?>
                                                <button class="px-3 py-1 text-xs bg-purple-600 text-white rounded hover:bg-purple-700 transition" 
                                                        onclick="openNilaiModal(<?php echo e(json_encode($ujian)); ?>)">
    ...
    <script>
        ...
        function submitNilai(e) {
            ...
            fetch('<?php echo e(route("dosen_penguji.penilaian.store")); ?>', {
                method: 'POST',
                headers: {
        ...
        function refreshPenilaianData() {
            fetch('<?php echo e(route("dosen_penguji.penilaian.data")); ?>', {
                method: 'GET',
                headers: {
                    'Accept': 'application/json',
