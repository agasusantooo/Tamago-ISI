    ...
    <script>
        ...
        function approveJadwal(id) {
            if (confirm('Setujui jadwal bimbingan ini?')) {
                fetch('<?php echo e(route("dospem.bimbingan.approve", ":id")); ?>'.replace(':id', id), {
                    method: 'POST',
                    headers: {
        ...
        function rejectJadwal(id) {
            if (confirm('Tolak jadwal bimbingan ini?')) {
                fetch('<?php echo e(route("dospem.bimbingan.reject", ":id")); ?>'.replace(':id', id), {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                    }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                headerToolbar: {
                    ...
                    fetch('<?php echo e(route("dospem.jadwal-bimbingan.events")); ?>')
                        .then(response => response.json())
                        .then(data => {
...
<?php /**PATH D:\C\Tamago-ISI\resources\views/dospem/jadwal-bimbingan.blade.php ENDPATH**/ ?>