...
<body class="bg-green-50 text-gray-800">
    <div class="flex h-screen overflow-hidden">
        ...
        <?php echo $__env->make('koordinator_tefa.partials.sidebar-koordinator', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <div class="flex-1 flex flex-col overflow-hidden">
            
            
            <?php echo $__env->make('koordinator_tefa.partials.header-koordinator', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        ...
                        <div class="col-span-8">
                            <div class="bg-white rounded-xl shadow p-4">
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <span class="text-xs text-gray-500"><?php echo e(collect($pending['tefa_registrations'] ?? [])->count()); ?> Pending</span>
                                </div>

                                <div class="space-y-3">
                                    <?php $__currentLoopData = $pending['tefa_registrations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center justify-between bg-gray-50 p-3 rounded">
                                        <div>
                                            <div class="text-sm font-medium">Pendaftaran TEFA</div>
                                            <div class="text-xs text-gray-600">Mahasiswa: <?php echo e(optional($t->mahasiswa)->nama ?? 'N/A'); ?> (<?php echo e(optional($t->mahasiswa)->nim ?? 'N/A'); ?>)</div>
                                        </div>
                                        <div class="flex items-center space-x-2">
                                            <a href="<?php echo e(route('koordinator_tefa.monitoring')); ?>" class="px-3 py-1 bg-green-600 text-white rounded">✓</a>
                                            <a href="<?php echo e(route('koordinator_tefa.monitoring')); ?>" class="px-3 py-1 bg-red-600 text-white rounded">✕</a>
                                        </div>
                                    </div>
...
</html><?php /**PATH D:\C\Tamago-ISI\resources\views/koordinator_tefa/dashboard.blade.php ENDPATH**/ ?>