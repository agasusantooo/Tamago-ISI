<header class="bg-white border-b shadow-md">
    <div class="flex items-center px-6 py-4">
        <div class="flex-1 mr-8 flex items-center space-x-3">
            ...
            <div>
                <h1 class="text-lg font-semibold text-gray-700">Koordinator Story Conference</h1>
                <div class="mt-2 mb-1">
...
<?php /**PATH D:\C\Tamago-ISI\resources\views/koordinator_story_conference/partials/header-koordinator.blade.php ENDPATH**/ ?>