                ...
                <div class="">
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="text-sm text-gray-600">Mahasiswa Aktif: <span id="dospemMahasiswaAktif" class="font-semibold text-blue-700"><?php echo e($mahasiswaAktifCount ?? '-'); ?></span> | Tugas Review: <span id="dospemTugasReview" class="font-semibold text-blue-700"><?php echo e($tugasReview ?? '-'); ?></span></div>
                        </div>
    ...
    <script>
        ...
        async function fetchMahasiswaBimbinganData() {
            try {
                ...
                const res = await fetch("<?php echo e(route('dospem.mahasiswa-bimbingan.data')); ?>", {
                    method: 'GET',
                    headers: {
                    ...
                    if (data.data.mahasiswaBimbingan.length === 0) {
                        ...
                        data.data.mahasiswaBimbingan.forEach(function(mhs) {
                            ...
                            row.innerHTML = `
                                ...
                                <td class="px-4 py-3 text-center">
                                    <a href="<?php echo e(url('dospem/mahasiswa-bimbingan/')); ?>/${mhs.nim}" class="px-3 py-1 text-xs bg-blue-600 text-white rounded hover:bg-blue-700">
                                        <i class="fas fa-eye mr-1"></i>Detail
                                    </a>
                                </td>
                            `;
...
<?php /**PATH D:\C\Tamago-ISI\resources\views/dospem/mahasiswa-bimbingan.blade.php ENDPATH**/ ?>