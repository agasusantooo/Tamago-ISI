...
function submitAccBimbingan() {
    ...
    const approveUrl = `<?php echo e(route('dospem.bimbingan.approve', ['id' => 'PLACEHOLDER'])); ?>`.replace('PLACEHOLDER', currentBimbinganId);
    const rejectUrl = `<?php echo e(route('dospem.bimbingan.reject', ['id' => 'PLACEHOLDER'])); ?>`.replace('PLACEHOLDER', currentBimbinganId);
...
<?php /**PATH D:\C\Tamago-ISI\resources\views/dospem/modals/acc-bimbingan-modal.blade.php ENDPATH**/ ?>