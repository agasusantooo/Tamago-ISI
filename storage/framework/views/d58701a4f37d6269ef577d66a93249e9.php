        ...
        <aside class="w-64 bg-white shadow-lg flex flex-col" id="sidebar">
            ...
            <nav class="flex-1 overflow-y-auto py-4">
                <ul class="space-y-1 px-3">
                    <li>
                        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center space-x-3 px-4 py-3 <?php echo e(request()->routeIs('dashboard') ? 'text-purple-900 bg-purple-50' : 'text-gray-700 hover:bg-gray-100'); ?> rounded-lg font-medium transition">
                            <i class="fas fa-home w-5"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('kaprodi.statistik')); ?>" class="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition">
                            <i class="fas fa-chart-bar w-5"></i>
                            <span>Statistik Global TA</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('kaprodi.manajemen-data')); ?>" class="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition">
                    ...
                    <li>
                        <a href="<?php echo e(route('kaprodi.monitoring')); ?>" class="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition">
                            ...
                            <div class="bg-green-50 rounded-lg p-6 border-l-4 border-green-600">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-xs text-green-600"><?php echo e(round(($mahasiswaLulus/$totalMahasiswa)*100, 1)); ?>% dari total</p>
                                    </div>
                            ...
                            <div class="bg-orange-50 rounded-lg p-6 border-l-4 border-orange-600">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-xs text-orange-600"><?php echo e(round(($belumLulus/$totalMahasiswa)*100, 1)); ?>% dari total</p>
                                    </div>
...
</html><?php /**PATH C:\laragon\www\tam\ooo\Tamago-ISI-main\resources\views/dashboards/kaprodi.blade.php ENDPATH**/ ?>