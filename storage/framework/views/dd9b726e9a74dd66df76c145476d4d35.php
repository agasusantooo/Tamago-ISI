            ...
            <div class="space-y-6">
                <div>
                    ...
                    <?php if(!empty($dosenLabel)): ?>
                        ...
                        <?php else: ?>
                            <p class="text-sm text-gray-500"><?php echo e($dosenLabel); ?></p>
                        <?php endif; ?>
                    <?php else: ?>
                ...
                <div>
                    ...
                    <a href="<?php echo e(Storage::disk('public')->url($proposal->file_proposal)); ?>" target="_blank" rel="noopener" class="flex items-center space-x-3 bg-gray-100 p-3 rounded-lg hover:bg-gray-200 transition">
...
<?php echo $__env->make('mahasiswa.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\C\Tamago-ISI\resources\views/mahasiswa/proposal/show.blade.php ENDPATH**/ ?>