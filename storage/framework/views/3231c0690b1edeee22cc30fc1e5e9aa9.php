...
<?php $__env->startSection('page-title', 'Naskah & Karya'); ?>
                                        ...
                                        <form method="POST" action="<?php echo e(route('mahasiswa.naskah-karya.upload')); ?>" enctype="multipart/form-data">
                                            ...
                                            <?php if(optional($projek)->file_naskah_publikasi): ?>
                                                <div class="mt-3 bg-green-50 border border-green-200 rounded p-3">
                                                    ...
                                                    <a href="<?php echo e(route('mahasiswa.naskah-karya.download', [$projek->id_proyek_akhir ?? $projek->id, 'naskah'])); ?>" class="text-sm text-blue-600 hover:underline"><i class="fas fa-download mr-1"></i> Download Naskah</a>
                                                </div>
                                            <?php endif; ?>
...
<?php echo $__env->make('mahasiswa.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tam\ooo\Tamago-ISI-main\resources\views/mahasiswa/naskah-karya.blade.php ENDPATH**/ ?>