            ...
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $storyConferences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <?php echo e($sc->projekAkhir ? $sc->projekAkhir->judul : '-'); ?>

                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <?php echo e($sc->projekAkhir && $sc->projekAkhir->mahasiswa ? $sc->projekAkhir->mahasiswa->nama : '-'); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH C:\laragon\www\tam\ooo\Tamago-ISI-main\resources\views/livewire/mahasiswa/story-conference.blade.php ENDPATH**/ ?>