        ...
        <ul class="space-y-1 px-3">
            <li>
                <a href="<?php echo e(route('kaprodi.dashboard')); ?>"
                   ...
                   <?php echo e(request()->routeIs('kaprodi.dashboard') ? 'bg-teal-100 text-teal-700 font-semibold' : 'text-gray-700 hover:bg-teal-50'); ?>">
            ...
            <li>
                <a href="#"
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition
                   <?php echo e(request()->routeIs('kaprodi.profile') ? 'bg-teal-100 text-teal-700 font-semibold' : 'text-gray-700 hover:bg-teal-50'); ?>">
...
<?php /**PATH D:\C\Tamago-ISI\resources\views/kaprodi/partials/sidebar-kaprodi.blade.php ENDPATH**/ ?>