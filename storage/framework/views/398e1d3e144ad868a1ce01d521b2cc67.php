            ...
            <header class="bg-white shadow-sm z-10">
                <div class="flex items-center justify-between px-6 py-4">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-3">
                            <img src="<?php echo e(asset('images/logo-isi.png')); ?>" alt="Logo ISI" class="w-8 h-8 object-contain">
...
<?php /**PATH D:\C\Tamago-ISI\resources\views\dashboards\pembimbing.blade.php ENDPATH**/ ?>