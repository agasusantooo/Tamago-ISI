                            ...
                            <table class="w-full">
                                ...
                                <tbody class="divide-y divide-blue-50">
                                    ...
                                    <tr class="hover:bg-blue-50 transition">
                                        <td class="px-4 py-3"><p class="font-medium text-blue-900"><?php echo e($item['mahasiswa']); ?></p></td>
                                        <td class="px-4 py-3"><p class="text-sm text-gray-700"><?php echo e($item['jenis']); ?></p></td>
                                        <td class="px-4 py-3 text-center text-sm text-gray-600"><?php echo e($item['tanggal']); ?></td>
                                        <td class="px-4 py-3 text-center">
                                            <a href="<?php echo e($item['file']); ?>" download class="px-3 py-1 text-xs bg-blue-100 text-blue-800 rounded hover:bg-blue-200 mr-2">
                                                <i class="fas fa-download mr-1"></i>Download
                                            </a>
                                            <button @click="selectedTask = <?php echo e(json_encode($item)); ?>; showModal = true" class="px-3 py-1 text-xs bg-green-600 text-white rounded hover:bg-green-700">
...
</html><?php /**PATH C:\laragon\www\tam\ooo\Tamago-ISI-main\resources\views/dospem/review-tugas.blade.php ENDPATH**/ ?>