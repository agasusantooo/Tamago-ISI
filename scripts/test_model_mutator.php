...
echo 'status_ujian property after direct mutator call: ';
var_export($ujian->status_ujian);
echo "\n";
echo 'raw attributes after direct mutator call: ';
var_export($ujian->getAttributes());
echo "\n";
...
echo 'after fill status_ujian property: ';
var_export($ujian->status_ujian);
echo "\n";
echo 'raw attributes after fill: ';
var_export($ujian->getAttributes());
echo "\n";
