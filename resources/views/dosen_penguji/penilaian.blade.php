        ...
        function submitNilai(e) {
            ...
            .then(data => {
                if (data.status === 'success') {
                        ...
                        fetch('{{ route("dosen_penguji.dashboard.data") }}', { method: 'GET', headers: { 'Accept': 'application/json', 'X-CSRF-TOKEN': csrfToken } }).catch(e => console.warn('dashboard refresh failed', e));
                    } else {
