            ...
            <div class="bg-green-50 rounded-lg p-6 border-l-4 border-green-600">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-green-600">{{ $totalMahasiswa ? round(($mahasiswaLulus/$totalMahasiswa)*100, 1) : 0 }}% dari total</p>
                    </div>
            ...
            <div class="bg-orange-50 rounded-lg p-6 border-l-4 border-orange-600">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-orange-600">{{ $totalMahasiswa ? round(($belumLulus/$totalMahasiswa)*100, 1) : 0 }}% dari total</p>
                    </div>
