<header class="bg-white border-b shadow-md">
    <div class="flex items-center px-6 py-4">
        <div class="flex-1 mr-8">
            ...
            <div class="mt-2 mb-1">
                <p class="text-xs text-gray-500">Mahasiswa Aktif: <span class="font-semibold text-green-600">{{ $mahasiswaAktifCount }}</span> | Tugas Review: <span class="font-semibold text-teal-600">{{ $tugasReview }}</span></p>
            </div>
            <div class="h-3"></div>
        </div>
