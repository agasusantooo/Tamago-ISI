...
--
-- Table structure for table `activity_semesters`
--

CREATE TABLE `activity_semesters` (
...
(2, 'Diskusi Proposal', NULL, NULL, NULL, 'pending', NULL, 114, '71220022', NULL, '2025-11-30', '14:00:00', '15:00:00', NULL, NULL, NULL, '2025-11-26 20:43:53', '2025-11-26 20:43:53', 'NIDN001'),
(3, 'Revisi Bab 3', NULL, NULL, NULL, 'approved', NULL, 114, '71220022', NULL, '2025-12-04', '15:30:00', '16:30:00', NULL, NULL, NULL, '2025-11-26 20:43:53', '2025-11-26 20:43:53', 'NIDN001'),
...
(7, 'bab 2', 'gimana?', NULL, 'bimbingan_files/ZD6JccH1BpfxkcEYAZ9DZtZZcjN24GXzYXXvQZfo.pdf', 'disetujui', NULL, 117, '71240099', NULL, '2025-11-28', '13:00:00', NULL, NULL, NULL, NULL, '2025-11-27 08:30:03', '2025-11-27 08:31:23', NULL),
(8, 'bab 1', 'latar belakang apakah sudah sesuai?', NULL, 'bimbingan_files/70bRhEIAsQz8RJh7Wp3Ja7k50cBicV69pDLq0pvC.pdf', 'disetujui', NULL, 119, '220026034', NULL, '2025-12-04', '09:00:00', NULL, NULL, NULL, NULL, '2025-12-04 08:45:51', '2025-12-04 09:08:23', NULL),
(9, 'bab 1', 'tujuan manfaat', NULL, 'bimbingan_files/xpMMAYSqzeR2xH8YWZkVeRo4Hl96XFMuzKL8u3f2.pdf', 'disetujui', NULL, NULL, '220026036', NULL, '2025-12-08', '09:00:00', NULL, NULL, NULL, NULL, '2025-12-07 19:58:37', '2025-12-07 20:04:43', NULL),
(10, 'bab 2', 'tinjauan pustaka', NULL, 'bimbingan_files/BGQNN0Q7o3HKO2bDmq8y4XqPi8Mnrp1G5gVjjvVx.pdf', 'disetujui', NULL, NULL, '220026036', NULL, '2025-12-11', '09:00:00', NULL, NULL, NULL, NULL, '2025-12-07 20:07:36', '2025-12-07 20:11:56', NULL),
(11, 'bab 2', 'revisi', NULL, 'bimbingan_files/Wq2gcXrV3f7yq0v9W0VEtUqu8wn7ZMW5zeBojjLK.pdf', 'disetujui', NULL, NULL, '220026036', NULL, '2025-12-12', '09:00:00', NULL, NULL, NULL, NULL, '2025-12-07 20:12:29', '2025-12-07 20:12:37', NULL),
(12, 'Landasan Teori', 'Landasan Teori', NULL, 'bimbingan_files/k3Z5ez0iMuXcfdQmGp8C2cyCEMm6NzL7M9EquXDx.pdf', 'disetujui', NULL, NULL, '220026036', NULL, '2025-12-15', '09:00:00', NULL, NULL, NULL, NULL, '2025-12-07 20:14:00', '2025-12-07 20:14:11', NULL),
(13, 'Metode Penelitian', '7. Metode Penelitian', NULL, 'bimbingan_files/idloloFm55xR3uw70kWOQTgftaePjSZ1LKtFG929.pdf', 'disetujui', NULL, NULL, '220026036', NULL, '2025-12-17', '09:00:00', NULL, NULL, NULL, NULL, '2025-12-07 20:15:02', '2025-12-07 20:15:14', NULL),
(14, 'Metode Penelitian', 'revisi', NULL, 'bimbingan_files/qkWCkWWmx93hQCwar8D9KpLHzjvW2Y0H3D6h1cuN.pdf', 'disetujui', NULL, NULL, '220026036', NULL, '2025-12-19', '09:00:00', NULL, NULL, NULL, NULL, '2025-12-07 20:16:47', '2025-12-07 20:16:57', NULL),
(15, 'Daftar Pustaka', 'Daftar Pustaka', NULL, 'bimbingan_files/qwc9m6WLCS0VnbGSqhXOa6FcWbyk6YPDmFxo6gTd.pdf', 'disetujui', NULL, NULL, '220026036', NULL, '2025-12-22', '09:00:00', NULL, NULL, NULL, NULL, '2025-12-07 20:17:50', '2025-12-07 20:18:02', NULL),
(16, 'Daftar Pustaka', 'revisi', NULL, NULL, 'disetujui', NULL, NULL, '220026036', NULL, '2025-12-24', '09:00:00', NULL, NULL, NULL, NULL, '2025-12-07 20:18:31', '2025-12-07 20:18:42', NULL);
...
CREATE TABLE `dosen` (
  ...
  `is_dosen_seminar` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `dosen` (`nidn`, `nama`, `jabatan`, `rumpun_ilmu`, `created_at`, `updated_at`, `status`, `jabatan_fungsional`, `is_dosen_seminar`, `user_id`) VALUES
('12345', 'Dosen 1', 'Dosen', 'Informatika', '2025-11-25 09:21:18', '2025-11-25 09:21:18', 'aktif', NULL, 0, NULL),
('54321', 'Dosen 2', 'Dosen', 'Informatika', '2025-11-25 09:21:18', '2025-11-25 09:21:18', 'aktif', NULL, 0, NULL);
...
--
-- Table structure for table `dosen_rumpun_ilmu`
--

CREATE TABLE `dosen_rumpun_ilmu` (
  `dosen_nidn` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rumpun_ilmu_id` bigint UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `jadwal_tefa_fair`
--

CREATE TABLE `jadwal_tefa_fair` (
  `id` bigint UNSIGNED NOT NULL,
  `nama_slot` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'e.g., "Pagi 08:00-10:00", "Siang 13:00-15:00"',
  `mata_kuliah` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Course/subject name',
  `ruang` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Room/space name',
  `tanggal_mulai` datetime NOT NULL,
  `tanggal_selesai` datetime NOT NULL,
  `kapasitas` int NOT NULL DEFAULT '1' COMMENT 'Max registrations for this slot',
  `daftar_sumber_daya_default` text COLLATE utf8mb4_unicode_ci COMMENT 'Default resource requirements template',
...
('220026034', 119, 'bene', 'bene@student.isi.ac.id', 'bimbingan_disetujui', '2025-12-04 07:44:53', '2025-12-04 09:08:23', NULL),
('220026036', 120, 'rule', 'rule@student.isi.ac.id', 'bimbingan_disetujui', '2025-12-07 19:43:42', '2025-12-07 20:04:43', NULL),
...
('712400999', 118, 'paku', 'paku@student.isi.ac.id', 'aktif', '2025-11-27 21:11:57', '2025-11-27 21:11:58', NULL),
...
(53, '2025_12_03_020000_add_rumpun_ilmu_to_proposals_table', 7),
(54, '2025_12_03_032219_add_status_to_tefa_fair_table', 7),
(55, '2025_12_03_034455_add_pasca_produksi_to_produksi_table', 7),
(56, '2025_12_04_153335_fix_proposals_feedback_column', 8),
(57, '2025_12_05_123456_replace_id_proyek_akhir_with_proposal_id_in_tefa_fair', 9),
(58, '2025_12_05_124500_create_jadwal_tefa_fair_table', 10),
(59, '2025_12_05_125000_add_fields_to_tefa_fair_table', 10),
(60, '2025_12_05_070517_fix_feedback_nullable_on_tim_produksi_table', 11),
(61, '2025_12_05_074000_fix_feedback_nullable_on_tim_produksi_table', 11),
(62, '2025_12_05_034932_create_semesters_table', 12),
(63, '2025_12_05_035142_create_timelines_table', 12),
(64, '2025_12_05_035803_add_type_to_ta_progress_stages_table', 12),
(65, '2025_12_05_040938_make_due_date_nullable_in_timelines_table', 12),
(66, '2025_12_05_041349_create_activity_semesters_table', 12),
(67, '2025_12_05_042636_add_jabatan_fungsional_to_dosen_table', 12),
(68, '2025_12_05_043102_add_user_id_to_dosen_table', 12),
(69, '2025_12_05_043604_create_rumpun_ilmus_table', 12),
(70, '2025_12_05_043625_create_dosen_rumpun_ilmu_table', 12),
(71, '2025_12_05_043855_add_is_dosen_seminar_to_dosen_table', 12),
(72, '2025_12_08_populate_mahasiswa_id_in_bimbingans', 13),
(73, '2025_12_08_045707_make_feedback_columns_nullable_in_tim_produksi_table', 14);
...
(2, '71240099', NULL, NULL, 'yayaya', 'proposals/71240099/proposal_v1_1764249149.pdf', NULL, NULL, NULL, NULL, NULL, 'aktif', '2025-12-03 09:59:43', '2025-12-03 09:59:43', NULL, NULL);
...
CREATE TABLE `proposals` (
  ...
  `rumpun_ilmu` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_proposal` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_pitch_deck` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `proposals` (`id`, `mahasiswa_nim`, `dosen_id`, `judul`, `deskripsi`, `rumpun_ilmu`, `file_proposal`, `file_pitch_deck`, `versi`, `status`, `tanggal_pengajuan`, `tanggal_review`, `feedback`, `created_at`, `updated_at`) VALUES
(1, '71220022', NULL, 'apapap', '', NULL, 'proposals/71220022/proposal_v1_1764213733.pdf', 'pitch-decks/71220022/pitchdeck_v1_1764213733.pdf', 1, 'disetujui', '2025-11-26 20:22:13', NULL, '', '2025-11-26 20:22:13', '2025-11-26 20:22:13'),
(2, '71240099', NULL, 'yayaya', '', NULL, 'proposals/71240099/proposal_v1_1764249149.pdf', 'pitch-decks/71240099/pitchdeck_v1_1764249149.pdf', 1, 'disetujui', '2025-11-27 06:12:29', '2025-11-27 08:03:29', 'oke sudah bagus', '2025-11-27 06:12:29', '2025-11-27 08:03:29'),
(3, '220026034', NULL, 'Perancangan Tata Artistik', 'Perancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata Artistik', 'Penciptaan Seni', 'proposals/220026034/proposal_v1_1764862527.pdf', 'pitch-decks/220026034/pitchdeck_v1_1764862527.pdf', 1, 'disetujui', '2025-12-04 08:35:27', '2025-12-04 08:54:22', 'okokok', '2025-12-04 08:35:27', '2025-12-04 08:54:22'),
(4, '220026036', NULL, 'Perancangan Tata Artistik', 'Perancangan Tata Artistik Perancangan Tata Artistik Perancangan Tata Artistik Perancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata Artistik Perancangan Tata Artistik Perancangan Tata Artistik Perancangan Tata ArtistikPerancangan Tata Artistik Perancangan Tata ArtistikPerancangan Tata ArtistikPerancangan Tata Artistik', 'Penciptaan Seni', 'proposals/220026036/proposal_v1_1765164798.pdf', 'pitch-decks/220026036/pitchdeck_v1_1765164798.pdf', 1, 'disetujui', '2025-12-07 20:33:18', '2025-12-07 20:33:38', 'sip bagus', '2025-12-07 20:33:18', '2025-12-07 20:33:38'),
(5, '220026036', NULL, 'seni', 'seni itu abstrak banget seni itu abstrak bangetseni itu abstrak bangetseni itu abstrak bangetseni itu abstrak bangetseni itu abstrak bangetseni itu abstrak bangetseni itu abstrak bangetseni itu abstrak bangetseni itu abstrak bangetseni itu abstrak bangetseni itu abstrak bangetseni itu abstrak bangetseni itu abstrak bangetseni itu abstrak banget', 'Penciptaan Seni', 'proposals/220026036/proposal_v2_1765178499.pdf', 'pitch-decks/220026036/pitchdeck_v2_1765178499.pdf', 2, 'diajukan', '2025-12-08 00:21:39', NULL, NULL, '2025-12-08 00:21:39', '2025-12-08 00:21:39');
...
--
-- Table structure for table `rumpun_ilmus`
--

CREATE TABLE `rumpun_ilmus` (
  `id` bigint UNSIGNED NOT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
('9S5RMRRNM36KKgEbyue1DAG1ugtCrCgVsjTeKPzH', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiencyMFNKQTFUN1BBaUVWN3FOUjZPSXZiY0JnblNhTlRoVjBraDhJRCI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJuZXciO2E6MDp7fXM6Mzoib2xkIjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MzA6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9yZWdpc3RlciI7fX0=', 1765180423),
('D1MOrfgT5mL70IVYi2lP7CPTU6gVwFctv5jbgLwq', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiVkhFck1NWWV0dkY2TWRzcFhQemdRWlNyQ1NDZmswSXZ5UFFqWHp4diI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJuZXciO2E6MDp7fXM6Mzoib2xkIjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6Mjc6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9sb2dpbiI7fX0=', 1765172868),
('GHZluZTqxR2TRQ5UPHJ5yE7q7djnKD4iplQDRzFY', 120, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '', 1765202447),
('qq23s2YU7rh1ZW774D3sOYcu5snqsvGfXMt20Kpt', 120, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '', 1765178500),
('Y9MuAN48jTNUiYbnXIiVTPnXobXN3G1ouLW4pTt9', 115, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '', 1765202970);
...
(2, NULL, 3, NULL, '220026034', 3, NULL, NULL, 'menunggu_persetujuan', '2025-12-04 08:56:50', '2025-12-04 08:56:50', 'Perancangan Tata Artistik', '18 Desember 2024 - 09:00 - 15:00 WIB', 'story-conference/220026034/storyconf_1764863810.pdf', '2025-12-04 08:56:50', NULL, NULL, NULL, NULL, NULL, NULL),
(3, NULL, 4, NULL, '220026036', 4, NULL, NULL, 'menunggu_persetujuan', '2025-12-07 20:33:52', '2025-12-07 20:33:52', 'Perancangan Tata Artistik', '18 Dec 2024 - 09:00 - 15:00 WIB', 'story-conference/220026036/storyconf_1765164832.pdf', '2025-12-07 20:33:52', NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `ta_progress_stages` (
  ...
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ta',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `ta_progress_stages` (`id`, `stage_code`, `stage_name`, `description`, `weight`, `sequence`, `is_active`, `type`, `created_at`, `updated_at`) VALUES
(1, 'proposal_submission', 'Pengajuan Proposal', 'Mahasiswa mengajukan proposal TA', 15.00, 1, 1, 'ta', '2025-11-25 09:21:15', '2025-11-25 09:21:15'),
(2, 'proposal_approved', 'Proposal Disetujui', 'Proposal telah disetujui oleh pembimbing/kaprodi', 10.00, 2, 1, 'ta', '2025-11-25 09:21:15', '2025-11-25 09:21:15'),
(3, 'bimbingan_progress', 'Bimbingan (Min. 8x)', 'Melakukan bimbingan minimal 8 kali', 25.00, 3, 1, 'ta', '2025-11-25 09:21:15', '2025-11-25 09:21:15'),
(4, 'story_conference', 'Story Conference', 'Mengikuti story conference', 10.00, 4, 1, 'ta', '2025-11-25 09:21:15', '2025-11-25 09:21:15'),
(5, 'production_upload', 'Upload Produksi', 'Mengunggah hasil produksi/karya', 15.00, 5, 1, 'ta', '2025-11-25 09:21:15', '2025-11-25 09:21:15'),
(6, 'exam_registration', 'Pendaftaran Ujian TA', 'Mendaftar ujian tugas akhir', 10.00, 6, 1, 'ta', '2025-11-25 09:21:15', '2025-11-25 09:21:15'),
(7, 'exam_completed', 'Ujian TA Selesai', 'Telah melaksanakan ujian TA', 10.00, 7, 1, 'ta', '2025-11-25 09:21:15', '2025-11-25 09:21:15'),
(8, 'final_submission', 'Submit Naskah & Karya Final', 'Mengunggah naskah dan karya final', 5.00, 8, 1, 'ta', '2025-11-25 09:21:15', '2025-11-25 09:21:15');
...
CREATE TABLE `tefa_fair` (
  ...
  `file_presentasi` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_slide` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `daftar_kebutuhan` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `daftar_sumber_daya` text COLLATE utf8mb4_unicode_ci,
  `status` enum('menunggu_review','disetujui','ditolak') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'menunggu_review',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `proposal_id` bigint UNSIGNED DEFAULT NULL,
  `mahasiswa_nim` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `tefa_fair`
--

INSERT INTO `tefa_fair` (`id_tefa`, `semester`, `mata_kuliah`, `file_presentasi`, `file_slide`, `daftar_kebutuhan`, `daftar_sumber_daya`, `status`, `created_at`, `updated_at`, `proposal_id`, `mahasiswa_nim`, `slot_id`) VALUES
(1, 'Gasal 2025/2026', NULL, 'tefa-fair/220026034/tefa_1764917596.pdf', NULL, 'asasaaa', NULL, 'menunggu_review', '2025-12-04 23:53:16', '2025-12-04 23:53:16', NULL, NULL, NULL),
(2, 'Gasal 2025/2026', NULL, 'tefa-fair/220026034/tefa_1764917648.pdf', NULL, 'asas', NULL, 'menunggu_review', '2025-12-04 23:54:08', '2025-12-04 23:54:08', NULL, NULL, NULL),
(3, 'Gasal 2025/2026', NULL, 'tefa-fair/220026034/tefa_1764918064.pdf', NULL, 'sasasas', NULL, 'menunggu_review', '2025-12-05 00:01:04', '2025-12-05 00:01:04', 3, '220026034', NULL),
(4, 'Gasal 2025/2026', NULL, 'tefa-fair/220026036/tefa_presentasi_1765168071.pdf', NULL, 'kursi', NULL, 'menunggu_review', '2025-12-07 21:27:51', '2025-12-07 21:27:51', NULL, '220026036', NULL),
(5, 'Gasal 2025/2026', NULL, 'tefa-fair/71240099/tefa_presentasi_1765176871.pdf', NULL, 'kursi', NULL, 'menunggu_review', '2025-12-07 23:54:31', '2025-12-07 23:54:31', NULL, '71240099', NULL);
...
CREATE TABLE `timelines` (
  `id` bigint UNSIGNED NOT NULL,
  `semester_id` bigint UNSIGNED NOT NULL,
  `ta_progress_stage_id` bigint UNSIGNED NOT NULL,
...
CREATE TABLE `tim_produksi` (
  ...
  `file_produksi` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `status_produksi` enum('belum_upload','menunggu_review','disetujui','revisi','ditolak') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'belum_upload',
  `tanggal_upload_pra` timestamp NULL DEFAULT NULL,
  `tanggal_upload_produksi` timestamp NULL DEFAULT NULL,
  `tanggal_review_pra` timestamp NULL DEFAULT NULL,
  `tanggal_review_produksi` timestamp NULL DEFAULT NULL,
  `status_pasca_produksi` enum('belum_upload','menunggu_review','disetujui','revisi','ditolak') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'belum_upload',
  `file_pasca_produksi` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `feedback_pasca_produksi` text COLLATE utf8mb4_unicode_ci,
  `tanggal_upload_pasca` timestamp NULL DEFAULT NULL,
  `tanggal_review_pasca` timestamp NULL DEFAULT NULL,
  `feedback_pra_produksi` text COLLATE utf8mb4_unicode_ci,
  `feedback_produksi` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tim_produksi` (`id`, `mahasiswa_id`, `proposal_id`, `dosen_id`, `file_skenario`, `file_storyboard`, `file_dokumen_pendukung`, `file_produksi`, `file_luaran_tambahan`, `catatan_produksi`, `status_pra_produksi`, `status_produksi`, `tanggal_upload_pra`, `tanggal_upload_produksi`, `tanggal_review_pra`, `tanggal_review_produksi`, `status_pasca_produksi`, `file_pasca_produksi`, `feedback_pasca_produksi`, `tanggal_upload_pasca`, `tanggal_review_pasca`, `feedback_pra_produksi`, `feedback_produksi`, `created_at`, `updated_at`) VALUES
(1, 117, 2, NULL, 'produksi/117/skenario_1764257549.pdf', 'produksi/117/storyboard_1764257549.pdf', 'produksi/117/dokumen_1764257549.pdf', 'test.mp4', NULL, NULL, 'disetujui', 'disetujui', '2025-11-27 08:32:29', '2025-12-03 09:58:18', '2025-12-03 09:57:58', '2025-12-07 22:40:26', 'belum_upload', NULL, '', NULL, NULL, '', 'Bagus, sudah sesuai standar!', '2025-11-27 08:32:29', '2025-12-07 22:40:26'),
(2, 119, 3, NULL, 'produksi/119/skenario_1764918441.pdf', 'produksi/119/storyboard_1764918441.pdf', 'produksi/119/dokumen_1764918441.pdf', NULL, NULL, NULL, 'menunggu_review', 'disetujui', '2025-12-05 00:07:21', NULL, NULL, '2025-12-07 22:34:47', 'belum_upload', NULL, '', NULL, NULL, '', 'Approved by dosen', '2025-12-05 00:07:21', '2025-12-07 22:34:47'),
(3, 120, 4, NULL, 'produksi/120/skenario_1765168093.pdf', 'produksi/120/storyboard_1765168093.pdf', 'produksi/120/dokumen_1765168093.pdf', NULL, NULL, NULL, 'menunggu_review', 'belum_upload', '2025-12-07 21:28:13', NULL, NULL, NULL, 'belum_upload', NULL, '', NULL, NULL, '', '', '2025-12-07 21:28:13', '2025-12-07 21:28:13');
...
--
-- Dumping data for table `ujian_tugas_akhir`
--

INSERT INTO `ujian_tugas_akhir` (`id_ujian`, `id_proyek_akhir`, `file_surat_pengantar`, `file_transkrip_nilai`, `file_revisi`, `status_pendaftaran`, `status_ujian`, `status_revisi`, `tanggal_daftar`, `tanggal_submit_revisi`, `tanggal_ujian`, `hasil_akhir`, `catatan_penguj`, `status_kelayakan`, `created_at`, `updated_at`, `dosen_pembimbing_id`) VALUES
(1, 2, 'ujian-ta/117/surat_pengantar_1764781183.pdf', 'ujian-ta/117/transkrip_1764781183.pdf', NULL, 'pengajuan_ujian', 'belum_ujian', 'belum_revisi', '2025-12-03 09:59:43', NULL, NULL, NULL, NULL, 'belum', '2025-12-03 09:59:43', '2025-12-03 09:59:43', NULL);
...
(118, 'paku', 'paku@student.isi.ac.id', 1, NULL, '$2y$12$yli4I4dymd.jTdcG3NNlY.w1u5mf0X0dZal.30VgK4micGE9qzgha', NULL, 'light', NULL, '2025-11-27 21:11:58', '2025-11-27 21:11:58'),
(119, 'bene', 'bene@student.isi.ac.id', 1, NULL, '$2y$12$Prjp75cFBbiKXnFCSAHDHuXt18lxKs7EWlnM2cCMQVz9awU6vlaHu', NULL, 'light', NULL, '2025-12-04 07:44:53', '2025-12-04 07:44:53'),
(120, 'rule', 'rule@student.isi.ac.id', 1, NULL, '$2y$12$eVyFgPd0syjVhJQVfxrle.vR8/S4DP5NzF8s6OaYngxWlDsCyY9Oy', NULL, 'light', NULL, '2025-12-07 19:43:42', '2025-12-07 19:43:42');
...
--
-- Indexes for table `activity_semesters`
--
ALTER TABLE `activity_semesters`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `activity_semesters_type_unique` (`type`),
  ADD KEY `activity_semesters_semester_id_foreign` (`semester_id`);
...
--
-- Indexes for table `dosen_rumpun_ilmu`
--
ALTER TABLE `dosen_rumpun_ilmu`
  ADD PRIMARY KEY (`dosen_nidn`,`rumpun_ilmu_id`),
  ADD KEY `dosen_rumpun_ilmu_rumpun_ilmu_id_foreign` (`rumpun_ilmu_id`);
...
--
-- Indexes for table `jadwal_tefa_fair`
--
ALTER TABLE `jadwal_tefa_fair`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `rumpun_ilmus`
--
ALTER TABLE `rumpun_ilmus`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `rumpun_ilmus_nama_unique` (`nama`);
...
ALTER TABLE `tefa_fair`
  ...
  ADD KEY `tefa_fair_proposal_id_foreign` (`proposal_id`),
  ADD KEY `tefa_fair_slot_id_foreign` (`slot_id`);
...
ALTER TABLE `timelines`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `timelines_semester_id_ta_progress_stage_id_unique` (`semester_id`,`ta_progress_stage_id`),
  ADD KEY `timelines_ta_progress_stage_id_foreign` (`ta_progress_stage_id`);
...
ALTER TABLE `tim_produksi`
  ...
  ADD KEY `tim_produksi_status_produksi_akhir_index` (`status_produksi`);
...
--
-- AUTO_INCREMENT for table `activity_semesters`
--
ALTER TABLE `activity_semesters`
...
--
ALTER TABLE `bimbingans`
  MODIFY `id_bimbingan` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
-- AUTO_INCREMENT for table `jadwal_tefa_fair`
--
ALTER TABLE `jadwal_tefa_fair`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `projek_akhir`
  MODIFY `id_proyek_akhir` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `rumpun_ilmus`
--
ALTER TABLE `rumpun_ilmus`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `story_conference`
  MODIFY `id_conference` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tefa_fair`
  MODIFY `id_tefa` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- Constraints for table `activity_semesters`
--
ALTER TABLE `activity_semesters`
  ADD CONSTRAINT `activity_semesters_semester_id_foreign` FOREIGN KEY (`semester_id`) REFERENCES `semesters` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `dosen`
  ADD CONSTRAINT `dosen_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
--
-- Constraints for table `dosen_rumpun_ilmu`
--
ALTER TABLE `dosen_rumpun_ilmu`
  ADD CONSTRAINT `dosen_rumpun_ilmu_dosen_nidn_foreign` FOREIGN KEY (`dosen_nidn`) REFERENCES `dosen` (`nidn`) ON DELETE CASCADE,
  ADD CONSTRAINT `dosen_rumpun_ilmu_rumpun_ilmu_id_foreign` FOREIGN KEY (`rumpun_ilmu_id`) REFERENCES `rumpun_ilmus` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `tefa_fair`
  ADD CONSTRAINT `tefa_fair_proposal_id_foreign` FOREIGN KEY (`proposal_id`) REFERENCES `proposals` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `tefa_fair_slot_id_foreign` FOREIGN KEY (`slot_id`) REFERENCES `jadwal_tefa_fair` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `timelines`
--
ALTER TABLE `timelines`
  ADD CONSTRAINT `timelines_semester_id_foreign` FOREIGN KEY (`semester_id`) REFERENCES `semesters` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `timelines_ta_progress_stage_id_foreign` FOREIGN KEY (`ta_progress_stage_id`) REFERENCES `ta_progress_stages` (`id`) ON DELETE CASCADE;
